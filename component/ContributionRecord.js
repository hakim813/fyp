...
export default function ContributionRecord() {
  ...
  const [SOCSORecord, setSOCSORecord] = useState([]);
  const [KWSPRecord, setKWSPRecord] = useState([]);
  ...
  useEffect(() => {
    ...
    onValue(SPRecordref, (snapshot) => {
      ...
      setSOCSORecord(fetchedSOCSO);
      setKWSPRecord(fetchedKWSP);
    });
  }, []);
    ...
    <View style={styles.container3}>
      <View style={styles.container}>
        ...
        <ImageBackground
          ...
          resizeMode="cover"
        >
          <Text style={[styles.text]}>Contribution History</Text>
                  ...
                  renderItem={({ item }) => {
                    ...
                    : item.title} */}
                        ...
                        <View>
                          ...
                          >
                            RM {parseFloat(item.value).toFixed(2)}
                          </Text>
                          {/* <View
                            style={{
                              flexDirection: "row",
