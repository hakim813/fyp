            ...
            {section === "Profile Pic" && (
              ...
              >
                ...
                {image.length <= 0 ? (
                  ...
                  >
                    <View style={{ alignItems: "center" }}>
                      <Icon name="file-image-o" size={40} color={"#555555"} />
                      <Text
                        style={{
                          fontFamily: "Nunito-Bold",
                          fontSize: 15,
                ...
                {LANGUAGES.map((lang) => (
                  ...
                  >
                    <Checkbox
                      ...
                      color={
                        selectedLanguages.includes(lang) ? "#296746" : undefined
                      }
                    />
                    <Text
                      style={{
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {INSURANCE.map((u) => (
                      <Picker.Item key={u} label={u} value={u} color="black" />
                    ))}
                    {/* Add more categories as needed */}
                  </Picker>
                  <TouchableOpacity
            ...
            {section === "Compliance" && (
              ...
              >
                ...
                >
                  ...
                  >
                    {selectedInsurance ? selectedInsurance : "Select Insurance"}
                  </Text>
                </TouchableOpacity>
