...
export default function Home(){
    ...
    return (
        <View style={[stylesHome.bg,{paddingTop: 0, backgroundColor: 'white', alignItems: 'center'}]}>
          <View style={{width: '100%', height: 200, backgroundColor: '#50c878', padding: 0, borderBottomLeftRadius: 50, borderBottomRightRadius: 50, alignItems: 'center', justifyContent: 'center',}}>
              <LinearGradient
                colors={['#03633a', '#95f6cc80']} // start to end gradient
                start={{ x: 1, y: 0.5 }}
                end={{ x: 0, y: 0 }}
                style={[styles.container, {width: '100%', paddingTop: Platform.OS === 'ios' ? StatusBar.currentHeight+50 : StatusBar.currentHeight}]}
              >
              {detail ? (
                  <>
          ...
          <View style={{ width: '100%', height: 280, paddingLeft: 10,  marginHorizontal: 40 }}>
              <Text style={{fontFamily: 'Nunito-ExtraBold', fontSize: 25, marginTop: 15, marginHorizontal: 15}}>Features</Text>
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                <TouchableOpacity style={[stylesHome.features, {backgroundColor: '#D3C2F8'}]} onPress={()=>navi.navigate('Forum')}>
                    <LinearGradient
                        ...
                        style={[stylesHome.features, {alignItems:'center', justifyContent: 'center'}]}
                    >
                        <Icon
                          name="commenting"
                          size={80}
                        ...
                        />
                        <View style={{alignItems: 'center'}}><Text style={{fontFamily: 'Nunito-Bold',color: '#fefefe', fontSize: 25}}>Forum</Text></View>
                      </LinearGradient>
                </TouchableOpacity>
                <TouchableOpacity style={[stylesHome.features, {backgroundColor: '#FAE2C8'}]} onPress={()=>navi.navigate('FinanceManager')}>
                {/* <View style={{ borderRadius: 15, alignItems:'center', justifyContent: 'center', height: 120,}}>
                  <Icon
                          name="money"
                          size={80}
                          color={'#fefefe'}
                      ...
                      {/* <View style={{alignItems: 'center'}}><Text style={{fontFamily: 'Nunito-Bold',color: '#fefefe',  fontSize: 25}}>Finance</Text></View> */}
                      <LinearGradient
                        colors={['#03633a', '#95f6cc']} // start to end gradient
                        start={{ x: 0, y: 0 }}
                        end={{ x: 0.5, y: 1.5 }}
                ...
                <TouchableOpacity style={[stylesHome.features, {backgroundColor: '#FAE2C8'}]} onPress={()=>navi.navigate('ScanReceipt')}>
                   <View style={{ borderRadius: 15, alignItems:'center', justifyContent: 'center', height: 120}}>
                        <Icon
                          name="money"
                          size={80}
                ...
                <TouchableOpacity style={[stylesHome.features, {backgroundColor: '#CDF464'}]} onPress={()=>navi.navigate('SPHome')}>
                   <View style={{ borderRadius: 15, alignItems:'center', justifyContent: 'center', height: 120}}>
                      <Icon
                    ...
                    <View style={{alignItems: 'center'}}><Text style={{fontFamily: 'Nunito-Bold',color: '#fefefe', fontSize: 25}}>Helpdesk</Text></View>
                </TouchableOpacity>
          ...
          <View style={{ width: '100%', height: 200,  paddingHorizontal: 10, marginHorizontal: 30 }}>
          <Text style={{fontFamily: 'Nunito-ExtraBold', fontSize: 25, margin: 5, marginHorizontal:15}}>Information</Text>
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
