...
export default function NotiReminder({ route }) {
  ...
  const { scheme, chosenPlan } = route.params;
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View style={[styles.container2, { marginHorizontal: 15, flex: 0 }]}>
              ...
              <TextInput
                style={[styles.input, { fontFamily: 'Nunito-Bold', color: '#303030' }]}
                value={scheme}
                editable={false}
              />
              ...
              {/* Date Picker */}
              <Text style={[styles.labelInput, { textAlign: 'center' }]}>Reminder Date</Text>
              ...
              {/* Time Picker */}
              <Text style={[styles.labelInput, { textAlign: 'center', marginTop: 10 }]}>Reminder Time</Text>
              <View style={{ alignItems: 'center' }}>
              <TouchableOpacity 
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  navi.navigate('SPHome', { pDate: date, pTime: time, notes: notes });
                }}
              >
                <Text style={{ color: '#fdfdfd', fontWeight: 'bold' }}>Set Reminder</Text>
              </TouchableOpacity>
            </View>
          </LinearGradient>
        </View>
